...
ax1.plot(task_impedance_ts[:, 1], task_impedance_ts[:, 3], color="#2166ac")
ax1.plot(joint_impedance_ts[:, 1], joint_impedance_ts[:, 3], color="#b2182b")
...
ax3.plot(task_impedance_ts[:, 1], task_impedance_ts[:, 2], task_impedance_ts[:, 3], color="#2166ac")
ax3.plot(joint_impedance_ts[:, 1], joint_impedance_ts[:, 2], joint_impedance_ts[:, 3], color="#b2182b")
...
ax4.plot(task_impedance_ts[:, 1], task_impedance_ts[:, 2], color="#2166ac")
ax4.plot(joint_impedance_ts[:, 1], joint_impedance_ts[:, 2], color="#b2182b")
...
ax5.plot(task_impedance_ts[:, 2], task_impedance_ts[:, 3], color="#2166ac")
ax5.plot(joint_impedance_ts[:, 2], joint_impedance_ts[:, 3], color="#b2182b")
